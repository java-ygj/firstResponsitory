	...
	<form id="wu-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="hidden" name="departmentId" class="wu-text" /></td>
            </tr>
             <tr>
                <td align="right">部门编号:</td>
                <td><input type="text" name="departmentDes" class="wu-text" /></td>
            </tr>
            <tr>
                <td align="right">部门名称:</td>
                <td><input type="text" name="departmentName" class="wu-text" /></td>
            </tr>
             <tr>
                <td align="right">删除状态:</td>
                <td><input type="text" name="delDepartmentStatus" class="wu-text" /></td>
            </tr>
        </table>
    </form>
</div>
...
//easyui带参数向后台发送请求
	...
	* 模糊查询/* 	name="key" */
	function selectByKey(){
		var key = $("#key").val();
		var str = 'selectDepartmentByKey.do'
		commonLoad(str);
	}
	...
	*/
	$(function(){
		commonLoad('selectDepartmentBySql.do')
	})
	/**
	* 公共部分 <td><input type="hidden" name="departmentId" class="wu-text" /></td>
    </tr>
    <tr>
        <td align="right">部门名称:</td>
        <td><input type="text" name="departmentName" class="wu-text" /></td>
	*/
	function commonLoad(str){
		$('#wu-datagrid').datagrid({
			...
			columns:[[
				{ checkbox:true},
				{ field:'departmentId',title:'部门id',width:50},
				{ field:'departmentDes',title:'部门编号',width:50},
				{ field:'departmentName',title:'部门名称',width:50},
				{ field:'delDepartmentStatus',title:'删除状态',width:50}
