	...
	<form id="wu-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="hidden" name="recordId" class="wu-text" /></td>
            </tr>
            <tr>
                <td align="right">档案编号:</td>
                <td><input type="text" name="recordNo" class="wu-text" /></td>
            </tr>
			<tr>
                <td width="60" align="right">员工编号:</td>
                <td><input type="text" name="empolyeeNo" class="wu-text" /></td>
            </tr>
            <!-- <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="recordName" class="wu-text" /></td>
            </tr><tr>
           ...
           <!--  <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="contentDigest" class="wu-text" style="width:261px; height:100px;"/></td>
            </tr>
        </table>
    </form>
</div>
...
//easyui带参数向后台发送请求
	...
	*/
	$(function(){
		commonLoad('selectRecordBySql.do')
	})
	/**
	* 公共部分
	*/
	function commonLoad(str){
		$('#wu-datagrid').datagrid({
			...
			columns:[[
				{ checkbox:true},
				{ field:'recordId',title:'档案id',width:8},
		
				{ field:'recordNo',title:'档案编号',width:8},
				
				{ field:'empolyeeNo',title:'员工编号',width:8},
				
				{ field:'name',title:'名字',width:8}, 
				
				{ field:'recordName',title:'档案名称',width:8},
				{ field:'remark',title:'备注',width:12},
				
				{ field:'departmentId',title:'部门id',width:8},
				{ field:'contentDigest',title:'内容摘要',width:20}
			]]
		});
	}
</script>